/*
  IOT_CuP.ino
  Arduino IDE-compatible sketch for the ESP32-C3 health monitor project.
  ...
  Open this folder in the Arduino IDE. The "include" subfolder contains
  additional project headers, so the sketch uses relative paths like
  "include/config.h".
*/
...
// project headers are stored in the "include" folder
#include "config.h"
#include "sensors.h"
#include "utils.h"
